...
[![Code compilation tests](https://github.com/bonkmachines/ctrl-arduino/actions/workflows/code-compilation-tests.yml/badge.svg)](https://github.com/bonkmachines/ctrl-arduino/actions/workflows/code-compilation-tests.yml)
